...
/**
 * Cached dashboard data query - deduplicated within a single request.
 * Both layout and page can call this without duplicate DB queries.
 */
export const getDashboardDataCached = cache(
  async (): Promise<ActionResult<DashboardData>> => {
